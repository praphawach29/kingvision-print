...
### หมวดหมู่สินค้าในร้าน (ใช้ใน category parameter ของ search_products):
- เลเซอร์, เครื่องพิมพ์เลเซอร์ → "Laser Printer"
- ดอท, ดอทเมทริกซ์ → "Dot Matrix"
- สลิป, ปริ้นใบเสร็จ → "Slip Printer"
- หมึก, Ink, Toner → "หมึกพิมพ์"
- อะไหล่ → "อะไหล่"
