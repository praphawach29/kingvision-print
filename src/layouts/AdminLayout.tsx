...
import { LayoutDashboard, Package, ShoppingCart, Users, Settings, LogOut, Home, Menu, X, BarChart2, FileText, Bell, List, Tag, Box, Database, FileCheck, Receipt, Truck, Wrench } from 'lucide-react';
