          ...
          <table className="w-full text-left border-collapse">
            <thead className="bg-gray-50/50">
              <tr className="border-b border-gray-100 text-xs text-gray-400 uppercase tracking-widest">
                <th className="p-4 font-bold whitespace-nowrap">รูปภาพ</th>
                <th className="p-4 font-bold whitespace-nowrap">ชื่อสินค้า</th>
                <th className="p-4 font-bold whitespace-nowrap">แบรนด์/หมวดหมู่</th>
                <th className="p-4 font-bold whitespace-nowrap text-center">ราคา</th>
                <th className="p-4 font-bold whitespace-nowrap text-center">สต็อก</th>
            ...
            <tbody className="text-sm">
              {products.map((product) => (
                <tr key={product.id} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="p-4 font-black text-kv-navy text-base text-center">฿{product.price.toLocaleString()}</td>
